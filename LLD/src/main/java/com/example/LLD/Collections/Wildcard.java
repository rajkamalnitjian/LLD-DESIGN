...
/*
 Key learning :
Upper bound Wildcard − ? extends Type.(upto this class and subclasses)

Lower bound Wildcard − ? super Type. (above this  and including this one also)

Unbounded Wildcard − ? (any kind of object)

 Note :- at the run time  every wildcard replaced by their possible Type
 */
